...
@section('content')
    <div class="container mx-auto px-4">
        <h1 class="text-2xl font-bold my-4 text-gray-800 dark:text-gray-100">Edit Book</h1>

        <form action="{{ route('books.update', $book->id) }}" method="POST" class="bg-transparent p-6 rounded">
            @csrf
            @method('PUT')
