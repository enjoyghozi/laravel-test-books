...
<div class="container mx-auto px-4">
    ...
    <form action="{{ route('authors.update', $author->id) }}" method="POST" class="bg-transparent p-6 rounded">
        @csrf
        @method('PUT')
        ...
        <div class="mb-4">
            <label for="books" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Books</label>
